...
class BlobStorageAuthenticator
{
     ...
     *
     * @var UploadBase64Cache
     */
    private UploadBase64Cache $_cache;
     ...
     * @param UploadBase64Cache $cache                           Cache used to save/retrieve azure active directory
    ...
    private function _getAuthToken(): string
    {
        ...
        try {
            ...
            throw new AzureBlobStorageConnectionException('Unable to authenticate the security principal on Azure Active Directory',
                0, $e);
        }
        ...
        if (!$token || !$expiresIn) {
            throw new AzureBlobStorageConnectionException('The response returned by Azure Active Directory is not a valid response.');
        }
